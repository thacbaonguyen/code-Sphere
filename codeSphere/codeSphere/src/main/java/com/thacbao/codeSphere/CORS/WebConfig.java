...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:4200", "http://52.156.163.5:4200/",
                        "https://52.156.163.5:4200/", "https://codesphere.id.vn")
    ...
    public static CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOrigin("http://52.156.163.5:4200");
        configuration.addAllowedOrigin("https://52.156.163.5:4200/");
